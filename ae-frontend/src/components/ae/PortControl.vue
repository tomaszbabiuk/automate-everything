<template>
  <div>
    <v-btn v-if="valueClazz == 'Relay'" @click="togglePort()" :disabled="disabled">Toggle</v-btn>
    <v-slider v-model="powerLevel" v-if="valueClazz == 'PowerLevel'" hint="Changing" max="100" min="0"
