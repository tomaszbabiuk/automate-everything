...
class RegulatedPowerWithPresetsDeviceConfigurable : StateDeviceConfigurable() {
    ...
    private val preset1Field = PowerLevelField(FIELD_PRESET1, R.field_preset1_hint)
    private val preset2Field = PowerLevelField(FIELD_PRESET2, R.field_preset2_hint)
