...
class TwilightConditionConfigurable : ConditionConfigurable() {
    ...
    private val longitudeField = NullableBigDecimalField(FIELD_LONGITUDE, R.field_longitude_hint, BigDecimal.ZERO, RequiredBigDecimalValidator())

    private val latitudeField = NullableBigDecimalField(FIELD_LATITUDE, R.field_latitude_hint, BigDecimal.ZERO, RequiredBigDecimalValidator())
